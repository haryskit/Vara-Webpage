...
<main>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6">
                                <div class="hero-caption">
                                    ...
                                    <p data-animation="fadeInLeft" data-delay=".6s">TLorem ipsum dolor sit amet,
                                        consectetur adipiscing elit.
                                        Suspendisse varius enim in eros elementum tristique. Duis
                                        cursus, mi quis viverra ornare.</p>
                                    <!-- Hero Btn -->
                                    <a href="#" class="btn" data-animation="fadeInLeft" data-delay=".8s">Our
                                        Services</a>
                                </div>
                            </div>
                        </div>
        ...
        <!-- slider Area End--><!--? Clients Offers Start -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-offers mb-50 wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="offers-cap">
                                <span>1</span>
                                <h3><a href="services.php">Tailor Sweing</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-offers mb-50 wow fadeInUp" data-wow-delay=".4s">
                            ...
                            <div class="offers-cap">
                                <span>2</span>
                                <h3><a href="services.php">Mesurement</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in
                                    eros elementum tristique.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-offers mb-50 wow fadeInUp" data-wow-delay=".6s">
                            ...
                            <div class="offers-cap">
                                <span>3</span>
                                <h3><a href="services.php">Ready-made</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in
                                    eros elementum tristique.</p>
                            </div>
                        </div>
        ...
        <section class="visit-tailor-area fix">
            ...
            <div class="tailor-details">
                ...
                <p class="pera-top">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in
                    eros.</p>
